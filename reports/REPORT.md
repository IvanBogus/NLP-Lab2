...
|---|---:|---:|---:|---:|---:|---|
| stdlib regex | так | 0.312 | 471 | 279 | 353 | Практичний базовий варіант без зовнішніх залежностей. |
| stdlib split | так | 0.209 | 471 | 279 | 353 | Найпростіша токенізація через пробіли; швидка, але менш точна. |
| stdlib translate table | так | 0.607 | 471 | 279 | 353 | Практичний варіант через таблицю заміни пунктуації та split. |
| stdlib sentence regex | так | 0 | 40 | 37 | 40 | Токенізація на рівні речень для аналізу структури тексту. |
| NLTK wordpunct | так | 2425.953 | 471 | 279 | 353 | Альтернативна бібліотечна токенізація NLTK. |
| spaCy uk_core_news_sm | так | 6176.709 | 471 | 279 | 354 | Модельна NLP-обробка: токени, стоп-слова, потенційні леми та POS-теги. |
